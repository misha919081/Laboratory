...
# ==================================================================================================================== #
        ...
        self.tab1.startButton.clicked.connect(Matrix.determinant)
        self.tab1.resetButton = QPushButton('Очистить матрицу')
        self.tab1.resetButton.clicked.connect(Matrix.clearMatrix)
...
class Matrix(QWidget):
    ...
    def determinant(self):
        ...
        for i in range(self.MatrixGrid.rowCount()):
            for g in range(self.MatrixGrid.columnCount()):
                item = self.MatrixGrid.itemAt(k)
