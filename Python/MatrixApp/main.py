...
########################################################################################################################
    ...
    def MatrixMultiple(self):
        self.tab2.MatMult = Multiple(self.tab2.MatrixField1.itemAt(1), self.tab2.MatrixField2.itemAt(1))
...
class Multiple():
    ...
    def __init__(self, Matrix1, Matrix2):
        ...
        k = 0
        for i in range(Matrix1.widget().MatrixConstructor.itemAt(1).widget().value()):
            for g in range(Matrix1.widget().MatrixConstructor.itemAt(0).widget().value()):
                item = Matrix1.widget().MatrixGrid.itemAt(k)
                row.append(item.widget().value())
                k += 1
            MatrixData1.append([])
        ...
        k = 0
        for i in range(Matrix2.widget().MatrixConstructor.itemAt(1).widget().value()):
            for g in range(Matrix2.widget().MatrixConstructor.itemAt(0).widget().value()):
                item = Matrix2.widget().MatrixGrid.itemAt(k)
                row.append(item.widget().value())
                k += 1
            MatrixData2.append([])
